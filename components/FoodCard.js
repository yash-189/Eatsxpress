...
import { addToFav, getFav, removeFromFav, selectFavItems, selectFavItemsWithId } from '../features/favSlice';
import { getDatabase, onValue, ref } from 'firebase/database';
import { getAuth } from 'firebase/auth';

const FoodCard = ({ id, name, rating, image, lat, lng, offername, offertype, offer, time, reviews, address, category }) => {
    ...
    const items = useSelector((state) => selectFavItemsWithId(state, id))
    ...
    console.log(items.length, 'iiiiiiiiiiiiiiiiiii');
