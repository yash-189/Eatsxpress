    ...
    >
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused, color, size }) => (
            <HomeIcon name="home" color={color} size={focused ? 30 : 28} />
          )
      ...
      <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Updates',
          tabBarIcon: ({ focused, color, size }) => (
            <HeartIcon name="fav" color={color} size={focused ? 30 : 28} />
          ),
          headerShown: false,
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarButton: (props) => <TouchableOpacity style={{ top: 80, justifyContent: 'center', alignItems: 'center' }}
            ...
            <View
              style={{
                width: 52, height: 52, backgroundColor: '#FB6E3B', top: -22, justifyContent: 'center', alignItems: 'center', borderRadius: 50, padding: 10, shadowColor: '#FB6E3B',
                shadowOffset: {
                  width: 0,
                  height: 9,
                },
              ...
              <MagnifyingGlassIcon name="search" color={'white'} size={28} />
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused, color, size }) => (
            <ShoppingBagIcon name="cart" color={color} size={focused ? 30 : 28} />
          ),
